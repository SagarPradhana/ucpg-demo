export const en = {
  ...
  "admin.subtitle": "Platform administration and management",
  "admin.dashboard": "Dashboard",
  "admin.transactions": "Transactions",
  "admin.promoCodes": "Promo Codes",
  "admin.providers": "Providers",
  "admin.commission": "Commission Settings",
  "admin.exchangeRates": "Exchange Rates",
  ...
  "admin.dashboard.paymentsCount": "Payments",
  "admin.dashboard.paymentsAmount": "Amount",
  "admin.dashboard.last24Hours": "Last 24 Hours",
  "admin.dashboard.activePromoLinks": "Active Promo Links",
  "admin.dashboard.usedPromoCodes": "Used Promo Codes",
  "admin.dashboard.claimedFunds": "Claimed Funds",
  "admin.dashboard.unclaimedFunds": "Unclaimed Funds",
  "admin.dashboard.commissionIncome": "Commission Income",
  "admin.dashboard.daily": "Daily",
  "admin.dashboard.weekly": "Weekly",
  "admin.dashboard.transactionVolume": "Transaction Volume",
  "admin.dashboard.currencyDistribution": "Currency Distribution",
  "admin.dashboard.sent": "Sent",
  "admin.dashboard.received": "Received",
  "admin.dashboard.auditLog": "Audit Log",
  "admin.dashboard.entries": "entries",
  "admin.dashboard.search": "Search",
  "admin.dashboard.searchPlaceholder": "Search actions, users, resources...",
  "admin.dashboard.user": "User",
  "admin.dashboard.allUsers": "All users",
  "admin.dashboard.action": "Action",
  "admin.dashboard.allActions": "All actions",
  "admin.dashboard.timeRange": "Time Range",
  "admin.dashboard.last1Hour": "Last 1 hour",
  "admin.dashboard.last24Hours": "Last 24 hours",
  "admin.dashboard.last7Days": "Last 7 days",
  "admin.dashboard.last30Days": "Last 30 days",
  "admin.dashboard.allTime": "All time",
  "admin.dashboard.clearFilters": "Clear Filters",
  "admin.dashboard.timestamp": "Timestamp",
  "admin.dashboard.resource": "Resource",
  "admin.dashboard.status": "Status",
  "admin.dashboard.severity": "Severity",
  "admin.dashboard.ipAddress": "IP Address",
  "admin.dashboard.actions": "Actions",

  // Admin Transactions
  "admin.transactions.title": "Transaction Management",
  "admin.transactions.subtitle": "Monitor and manage all platform transactions",
  "admin.transactions.filters": "Filters",
  "admin.transactions.allStatus": "All Status",
  "admin.transactions.allCurrencies": "All Currencies",
  "admin.transactions.dateFrom": "Date From",
  "admin.transactions.dateTo": "Date To",
  ...
  "admin.transactions.netAmount": "Net Amount",
  "admin.transactions.providerFee": "Provider Fee",
  "admin.transactions.qrStatus": "QR Status",
  "admin.transactions.active": "Active",
  "admin.transactions.used": "Used",
  "admin.transactions.expired": "Expired",
  "admin.transactions.actions": "Actions",
  "admin.transactions.view": "View",
  "admin.transactions.export": "Export",

  // Admin Promo Codes
  "admin.promoCodes.title": "Promo Code Management",
  "admin.promoCodes.subtitle": "Create and manage promotional codes",
  "admin.promoCodes.createNew": "Create New Promo Code",
  "admin.promoCodes.code": "Code",
  "admin.promoCodes.amount": "Amount",
  "admin.promoCodes.currency": "Currency",
  "admin.promoCodes.createdDate": "Created Date",
  "admin.promoCodes.expirationDate": "Expiration Date",
  "admin.promoCodes.usageStatus": "Usage Status",
  "admin.promoCodes.qrLink": "QR Link",
  "admin.promoCodes.generateCode": "Generate Code",
  "admin.promoCodes.setExpiration": "Set Expiration",
  "admin.promoCodes.createPromoCode": "Create Promo Code",
  "admin.promoCodes.cancel": "Cancel",

  // Admin Providers
  "admin.providers.title": "Provider Management",
  "admin.providers.subtitle": "Manage external service providers",
  "admin.providers.addProvider": "Add New Provider",
  "admin.providers.name": "Name",
  "admin.providers.type": "Type",
  "admin.providers.apiEndpoint": "API Endpoint",
  "admin.providers.redirectLink": "Redirect Link",
  "admin.providers.transactionCount": "Transactions",
  "admin.providers.totalAmount": "Total Amount",
  "admin.providers.isActive": "Active",
  "admin.providers.lastActivity": "Last Activity",
  "admin.providers.edit": "Edit",
  "admin.providers.delete": "Delete",
  "admin.providers.activate": "Activate",
  "admin.providers.deactivate": "Deactivate",

  // Admin Commission
  "admin.commission.title": "Commission Settings",
  "admin.commission.subtitle": "Configure commission rates and policies",
  "admin.commission.globalSettings": "Global Settings",
  "admin.commission.globalPercentage": "Global Commission Percentage",
  "admin.commission.currencySpecific": "Currency-Specific Rates",
  "admin.commission.providerSpecific": "Provider-Specific Rates",
  "admin.commission.addCurrencyRate": "Add Currency Rate",
  "admin.commission.addProviderRate": "Add Provider Rate",
  "admin.commission.policyName": "Policy Name",
  "admin.commission.value": "Value (%)",
  "admin.commission.provider": "Provider",
  "admin.commission.isActive": "Active",
  "admin.commission.saveSettings": "Save Settings",

  // Admin Exchange Rates
  "admin.exchangeRates.title": "Exchange Rate Management",
  "admin.exchangeRates.subtitle": "Monitor and update cryptocurrency exchange rates",
  "admin.exchangeRates.refreshRates": "Refresh All Rates",
  "admin.exchangeRates.symbol": "Symbol",
  "admin.exchangeRates.price": "Price",
  "admin.exchangeRates.change24h": "24h Change",
  "admin.exchangeRates.lastUpdated": "Last Updated",
  "admin.exchangeRates.autoUpdate": "Auto Update",
  "admin.exchangeRates.manualUpdate": "Manual Update",
  "admin.exchangeRates.updateInterval": "Update Interval (minutes)",

  // Admin User Roles
  "admin.userRoles.title": "User Role Management",
  "admin.userRoles.subtitle": "Manage admin users and their permissions",
  "admin.userRoles.addAdmin": "Add New Admin",
  "admin.userRoles.name": "Name",
  "admin.userRoles.email": "Email",
  "admin.userRoles.role": "Role",
  "admin.userRoles.lastLogin": "Last Login",
  "admin.userRoles.isActive": "Active",
  "admin.userRoles.superAdmin": "Super Admin",
  "admin.userRoles.transactionAdmin": "Transaction Admin",
  "admin.userRoles.providerAdmin": "Provider Admin",
  "admin.userRoles.statisticsAdmin": "Statistics Admin",
  "admin.userRoles.permissions": "Permissions",
  "admin.userRoles.fullAccess": "Full access to all features",
  "admin.userRoles.transactionAccess": "Transaction management only",
  "admin.userRoles.providerAccess": "Provider management only",
  "admin.userRoles.statisticsAccess": "Statistics and reports only",

  // Admin Settings
  "admin.settings.title": "System Settings",
  "admin.settings.subtitle": "Configure platform-wide settings",
  "admin.settings.general": "General Settings",
  "admin.settings.security": "Security Settings",
  "admin.settings.notifications": "Notification Settings",
  "admin.settings.defaultQRExpiration": "Default QR Expiration (hours)",
  "admin.settings.maxDailyTransactionLimit": "Max Daily Transaction Limit",
  "admin.settings.maintenanceMode": "Maintenance Mode",
  "admin.settings.telegramNotifications": "Telegram Notifications",
  "admin.settings.exchangeRateMonitoring": "Exchange Rate Monitoring",
  "admin.settings.rateUpdateInterval": "Rate Update Interval (minutes)",
  "admin.settings.saveSettings": "Save Settings",
  "admin.settings.settingsUpdated": "Settings Updated",
  "admin.settings.settingsUpdateFailed": "Failed to Update Settings",

  // Admin Error Logs
  "admin.errorLogs.title": "Error Log Management",
  "admin.errorLogs.subtitle": "Monitor system errors and issues",
  "admin.errorLogs.clearLogs": "Clear All Logs",
  "admin.errorLogs.exportLogs": "Export Logs",
  "admin.errorLogs.timestamp": "Timestamp",
  "admin.errorLogs.errorCode": "Error Code",
  "admin.errorLogs.message": "Message",
  "admin.errorLogs.endpoint": "Endpoint",
  "admin.errorLogs.severity": "Severity",
  "admin.errorLogs.low": "Low",
  "admin.errorLogs.medium": "Medium",
  "admin.errorLogs.high": "High",
  "admin.errorLogs.critical": "Critical",

  // Admin Reports
  "admin.reports.title": "Reports & Analytics",
  "admin.reports.subtitle": "Generate and export platform reports",
  "admin.reports.generateReport": "Generate Report",
  "admin.reports.transactionReport": "Transaction Report",
  "admin.reports.transactionReportDesc": "Detailed transaction history and analytics",
  "admin.reports.userReport": "User Reports",
  "admin.reports.userReportDesc": "User activity and registration statistics",
  "admin.reports.financialReport": "Financial Reports",
  "admin.reports.financialReportDesc": "Revenue, profits, and financial summaries",
  "admin.reports.commissionReport": "Commission Report",
  "admin.reports.commissionReportDesc": "Commission earnings and fee breakdowns",
  "admin.reports.errorLogReport": "Error Log Report",
  "admin.reports.errorLogReportDesc": "System errors and technical issues",
  "admin.reports.customReport": "Custom Reports",
  "admin.reports.customReportDesc": "Customizable reports with flexible parameters",
  "admin.reports.userActivityReport": "User Activity Report",
  "admin.reports.providerPerformance": "Provider Performance",
  ...
  "admin.reports.reportGenerated": "Report Generated Successfully",
  "admin.reports.reportFailed": "Failed to Generate Report",
  "admin.reports.user": "User",
  "admin.reports.userId": "User ID",
  "admin.reports.registrationDate": "Registration Date",
  "admin.reports.totalTransactions": "Total Transactions",
  "admin.reports.totalVolume": "Total Volume",
  "admin.reports.period": "Period",
  "admin.reports.revenue": "Revenue",
  "admin.reports.expenses": "Expenses",
  "admin.reports.profit": "Profit",
  "admin.reports.commissionEarned": "Commission Earned",
  "admin.reports.transactionCount": "Transaction Count",
  "admin.reports.commissionRate": "Commission Rate",
  "admin.reports.affectedUsers": "Affected Users",
  "admin.reports.resolved": "Resolved",
  "admin.reports.metric": "Metric",
  "admin.reports.value": "Value",
  "admin.reports.change": "Change",
  ...
  "admin.actions.view": "View Details",
  "admin.actions.confirm": "Confirm",
  "admin.actions.reset": "Reset",

  // Admin Status Messages
  "admin.status.loading": "Loading...",
  "admin.status.saving": "Saving...",
  "admin.status.updating": "Updating...",
  "admin.status.deleting": "Deleting...",
  "admin.status.success": "Operation Successful",
  "admin.status.failed": "Operation Failed",
  "admin.status.noData": "No data available",
  "admin.status.confirmDelete": "Are you sure you want to delete this item?",
  "admin.status.unsavedChanges": "You have unsaved changes. Are you sure you want to leave?",
};
